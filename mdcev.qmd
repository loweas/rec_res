...
Here we provide code for running the MDCEV.
...
write_csv(final_data_2018, "data/final_data_2018.csv")
write_csv(final_data_2019, "data/final_data_2019.csv")
write_csv(final_data_2020, "data/final_data_2020.csv")
write_csv(final_data_2021, "data/final_data_2021.csv")
write_csv(final_data_2022, "data/final_data_2022.csv")
write_csv(final_data_2023, "data/final_data_2023.csv")
```
...
for (year in names(welfare_list)) {
  ...
  write.csv(welfare_summary,
            file = paste0("data/welfare_summary_", year, ".csv"),
            row.names = FALSE)
}
...
write.csv(welfare_2018_ind, "data/welfare_2018_ind.csv", row.names = FALSE)
write.csv(welfare_2019_ind, "data/welfare_2019_ind.csv", row.names = FALSE)
write.csv(welfare_2020_ind, "data/welfare_2020_ind.csv", row.names = FALSE)
write.csv(welfare_2021_ind, "data/welfare_2021_ind.csv", row.names = FALSE)
write.csv(welfare_2022_ind, "data/welfare_2022_ind.csv", row.names = FALSE)
write.csv(welfare_2023_ind, "data/welfare_2023_ind.csv", row.names = FALSE)
