...
# ── Test 2: Pairwise welfare stability — all three models ─────────────────────
...
# Test 1: Parameter stability — price coefficient across years 
# Already coded above — see price_stability_all

# Test 2: Convergent validity across models — do they agree on rankings? 
...
# Test 3: Transfer error across models 
...
# ── Test 4: Equality tests — are model welfare estimates significantly different from each other? 
# (Ji et al. Section 4)
...
#Test 5: Transfer error by year pair AND model pair 
