...
welfare_summary=read_csv("welfare_summary_2019.csv")
welfare_summary=welfare_summary %>%
  mutate(
    # Extract only the digits from the "policy" string and make it an integer
    parkname_numeric = as.integer(str_extract(policy, "\\d+"))
...
welfare_summary=read_csv("welfare_summary_2020.csv")
welfare_summary=welfare_summary %>%
  mutate(
    # Extract only the digits from the "policy" string and make it an integer
    parkname_numeric = as.integer(str_extract(policy, "\\d+"))
...
welfare_summary<- read_csv("welfare_summary_2021.csv")
...
welfare_summary<- read_csv("welfare_summary_2022.csv")
...
welfare_summary<- read_csv("welfare_summary_2023.csv")
...
rum_mle_52 <- mlogit(choice ~ price | 1 , data = df_idx_52)
